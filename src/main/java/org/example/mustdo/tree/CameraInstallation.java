...
public class CameraInstallation {


    public static void main(String[] args) {
        Integer[] tree2 = {0, 0, null, 0, null, 0, null, null, 0};
        TreeNode root2 = TreeBuilder.buildTree(tree2);
        Integer[] tree1 = {0,0,null,0,0};
        TreeNode root1 = TreeBuilder.buildTree(tree1);
        CameraInstallation obj = new CameraInstallation();

        System.out.println(obj.minCameraCover(root1));
        //System.out.println(obj.minCameraCover(root2));
